...
We are committed to fostering an open, welcoming, and productive environment for all contributors to *Lightstream*. We value collaboration, respect, and constructive discourse that advances the project's goals, which is to contribute positively and openly to the high-performance Rust data ecosystem.
...
- **Stay focused** - Keep discussions relevant to *Lightstream*'s goals and implementation
- **Be specific** - Provide concrete examples and clear reasoning
- **Respect design decisions** - Understand that *Lightstream* has specific design principles
...
- **Project goals** - Supporting *Lightstream*'s specific objectives and principles
