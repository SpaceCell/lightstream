...
"""UDS server streaming the demo table as Arrow IPC.
...
URI = os.environ.get("LIGHTSTREAM_EXAMPLE_URI", "uds:///tmp/lightstream-example/get_table.sock")

def serve():
    Path(URI.removeprefix("uds://")).parent.mkdir(parents=True, exist_ok=True)
