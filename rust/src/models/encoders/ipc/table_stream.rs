...
mod tests {
    ...
    fn test_write_categorical_column_u8() {
        ...
        let arr = CategoricalArray::from_parts(Vec64::from_slice(&[1u8, 0, 2, 1]), Vec64::from(dict_strs()), Some(make_bitmask(&[true, true, false, true])));
    ...
    fn test_write_categorical_column_u16() {
        ...
        let arr = CategoricalArray::from_parts(Vec64::from_slice(&[2u16, 1, 0, 2]), Vec64::from(dict_strs()), None);
    ...
    fn test_write_categorical_column_u64() {
        ...
        let arr = CategoricalArray::from_parts(Vec64::from_slice(&[0u64, 2, 1, 0]), Vec64::from(dict_strs()), None);
    ...
    fn test_ipc_file_write_read_dict() {
        ...
        let arr = CategoricalArray::from_parts(Vec64::from_slice(&[0u32, 1, 1, 2]), Vec64::from(dict_strs()), Some(make_bitmask(&[true, false, true, true])));
    ...
    fn test_ipc_file_write_read_dict() {
        ...
        let arr = CategoricalArray::from_parts(Vec64::from_slice(&[0u8, 1, 1, 2]), Vec64::from(dict_strs()), Some(make_bitmask(&[true, false, true, true])));
